#Leccion 05 Registros con Postgresql y Python
...
try:
    with conexion:
        with conexion.cursor() as cursor:
            ...
            valores= ('Carlos','Lara','clara@mail.com')_# Es una tupla
...
try:
    with conexion:
        with conexion.cursor() as cursor:
            ...
            valores= ('Juan Carlos','Roldan','rcarlos@mail.com',1)_# Es una tupla
            #conexion.commit() esto se utiliza para guardar los cambios en la base de datos
            cursor.executemany(sentencia,valores)#De esta manera ejecutamos la sentencia
